...
export const ThemeToggleButton1 = ({ className = "" }) => {
...
export const ThemeToggleButton2 = ({ className = "" }) => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === 'dark';
...
export const ThemeToggleButton3 = ({ className = "" }) => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === 'dark';
...
export const ThemeToggleButton4 = ({ className = "" }) => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === 'dark';
...
export const ThemeToggleButton5 = ({ className = "" }) => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === 'dark';
