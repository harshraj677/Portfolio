...
export default function OrbitingSkills() {
  ...
  const orbitConfigs = [
    { radius: 170, glowColor: 'cyan', delay: 0 },
    { radius: 280, glowColor: 'purple', delay: 1.5 }
  ];
  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden px-2 sm:px-4">
      {/* Background pattern */}
      ...
      <div 
        className="relative w-full min-h-[280px] h-[280px] sm:h-[380px] md:h-[520px] lg:w-[750px] lg:h-[750px] flex items-center justify-center scale-[0.55] sm:scale-[0.7] md:scale-[0.85] lg:scale-100 my-4 sm:my-6 md:my-8"
        onMouseEnter={() => setIsPaused(true)}
        onMouseLeave={() => setIsPaused(false)}
      >
        
        {/* Central "Code" Icon with enhanced glow */}
        <div className="w-32 h-32 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full flex items-center justify-center z-10 relative shadow-2xl">
          ...
          <div className="relative z-10">
            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="url(#gradient)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <defs>
