  ...
  const projects = [
    {
      id: 1,
      title: 'PDF Maker',
      description: 'PDF Designer: The Ultimate Free Online PDF Tool for All Your Needs',
    ...
    },
    {
      id: 2,
      title: 'Gatecraft',
      description: 'An interactive playground for learning and experimenting with digital logic gates. Select a gate, toggle the inputs, and see the magic happen!',
      image: '/port photo/Gatecraft.png',
      tags: ['React.js', 'TypeScript','Tailwind CSS','AI Gemini 2.5'],
      category: 'MERN Stack',
      liveLink: 'https://gatecraft.netlify.app/',
      githubLink: 'https://github.com/harshraj677/Gatecraft.git',
      featured: false,
      features: ['Analytics Dashboard', 'Post Scheduling', 'Engagement Metrics'],
      techStack: ['React.js', 'TypeScript','Tailwind CSS','AI Gemini 2.5']
    },
    {
      id: 3,
      title: 'Harx : My-Portfolio',
      description: 'Hi, I’m Harsh! Welcome to my digital space where I share my projects, achievements, and passion for tech. I love working on AI, ML, participating in hackathons, and constantly improving my skills. Explore my work and see what I’m building next. ',
      image: '/port photo/My-Portfolio.png',
      tags: ['JavaScript', 'Node.js', 'Tailwind CSS','EmailJS '],
      category: 'Full Stack',
      liveLink: 'https://harx.netlify.app/',
      githubLink: 'https://github.com/harshraj677/Portfolio.git',
      featured: false,
